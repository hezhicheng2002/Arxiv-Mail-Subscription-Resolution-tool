...
def generate_document(title, link, abstract, count, section):
    ...
    <button style="font-size: 0.8em; background-color: red; color: white; margin-left: 4em;" onclick="toggleAbstract('abstract_{section}')"><b>摘要</b></button>
    <p id="abstract_{section}" style="display:none; font-size:1em; margin-top: 0.25em; margin-left: 4em;">{abstract}</p>
    </div>
    <hr>
    '''
...
def generate_html_content(papers):
    ...
    for i, paper in enumerate(papers):
        ...
        document = generate_document(title, link, abstract, i + 1, section)
